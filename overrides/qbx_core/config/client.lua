...
return {
    ...
    characters = {
        ...
        limitNationalities = true, -- Setting this to false will allow players to enter whatever they want in the nationality field (To edit the list of nationalities, head to data/nationalities.lua)
